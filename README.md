# Real Estate Agency Database (Oracle SQL)

Relational database project for a real estate agency.
...
- `docs/project_description_pl.docx` – short domain description (PL)
